...
export default function ConditionalSelect({ value, onChange, options, placeholder, disabled }: ConditionalSelectProps) {
    ...
    <div className="relative">
      <button
        ...
        className={`w-full flex items-center justify-between gap-2 px-3 py-2.5 text-xs rounded-lg border transition-all ${
          ...
          open ? "border-primary ring-1 ring-primary-400/30" : "border-border hover:border-gray-300"
        } bg-card text-left`}
      >
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-2 px-3 py-2.5 text-xs text-left transition-all ${
                    opt.value === value
                      ...
                      : "text-foreground hover:bg-primary/10/60 hover:text-primary"
                  }`}
