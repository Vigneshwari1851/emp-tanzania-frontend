...
export const Permission = {
  ...
  // Loans & Advances
  VIEW_LOANS_ADVANCES: 'VIEW_LOANS_ADVANCES',
  MANAGE_LOANS_ADVANCES: 'MANAGE_LOANS_ADVANCES',
  ...
  // Future Modules
  VIEW_EMAIL_MANAGEMENT: 'VIEW_EMAIL_MANAGEMENT',
  VIEW_NOTIFY_MANAGEMENT: 'VIEW_NOTIFY_MANAGEMENT',
