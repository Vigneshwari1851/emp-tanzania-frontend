...
export const rolePermissions: PermissionMap = {
  [UserRoleVal.SUPER_ADMIN]: [
    ...
    PermissionVal.VIEW_LOANS_ADVANCES,
    PermissionVal.MANAGE_LOANS_ADVANCES,
...
export const navItemPermissions: Record<string, Permission[]> = {
  ...
  '/loans-advances': [PermissionVal.VIEW_ALL_PAYROLL, PermissionVal.VIEW_TEAM_PAYROLL, PermissionVal.VIEW_OWN_PAYROLL, PermissionVal.VIEW_LOANS_ADVANCES],
